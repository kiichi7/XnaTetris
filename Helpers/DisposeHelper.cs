#if TST_DISABLED
// Project: XnaTetris, File: DisposeHelper.cs
// Namespace: XnaTetris.Helpers, Class: DisposeHelper
...
using XnaTetris.Landscapes;
using XnaTetris.Shaders;
using XnaTetris.Tracks;
using Model = XnaTetris.Graphics.Model;
using Texture = XnaTetris.Graphics.Texture;
#endregion
...
namespace XnaTetris.Helpers
{
	...
	class DisposeHelper
	{
		...
		/// </summary>
		/// <param name="someObject">Some object</param>
		public static void Dispose(ref XnaTetris.Graphics.Texture someObject)
		{
			if (someObject != null)
				someObject.Dispose();
			someObject = null;
		...
		/// </summary>
		/// <param name="someObject">Some object</param>
		public static void Dispose(ref XnaTetris.Graphics.TextureFont someObject)
		{
			if (someObject != null)
				someObject.Dispose();
			someObject = null;
		...
		/// </summary>
		/// <param name="someObject">Some object</param>
		public static void Dispose(ref XnaTetris.Graphics.LensFlare someObject)
		{
			if (someObject != null)
				someObject.Dispose();
			someObject = null;
